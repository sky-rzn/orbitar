...
//  Тайлы/фоны собираются для каждой темы (сектора) отдельно.
// ============================================================
'use strict';

const PAL = {
  '.': null,
  // ---- база (СЕКТОР 7 — орбитальная литейная) ----
  ...
  v: '#3d2a6b',
  // ---- сдвиг палитры (СЕКТОР 12 — заросший реактор) ----
...
// Тема = таблица подмены ключей палитры. null — исходная (сектор 7).
...
// ------------------------------------------------------------
//  ДРОН 16x12, 2 кадра (в секторе 12 перекрашивается темой — «ОСА»)
// ------------------------------------------------------------
const DRONE = [
  [
    '.....RR.........',
...
// ------------------------------------------------------------
//  БОСС «ROOTMIND» 40x34 — корневая машина сектора 12 (рисуется процедурно)
...
// ------------------------------------------------------------
//  ФОНЫ — СЕКТОР 12 (заросший реактор): та же схема из трёх слоёв
// ------------------------------------------------------------
